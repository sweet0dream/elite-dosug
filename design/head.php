...
<head>
	...
	<link rel="icon" type="image/png" sizes="32x32" href="/assets/touch-icons/<?= $city['name'] ?>/favicon-32x32.png">
	<link rel="icon" type="image/png" sizes="96x96" href="/assets/touch-icons/<?= $city['name'] ?>/favicon-96x96.png">
	<link rel="icon" type="image/png" sizes="16x16" href="/assets/touch-icons/<?= $city['name'] ?>/favicon-16x16.png">
